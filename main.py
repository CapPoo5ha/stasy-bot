...
WELCOME_TEXT = (
    ...
    "{emoji1}работала на фрилансе в более 30 нишах\n"
    "{emoji1}работала в креативном маркетинговом агентстве с федеральными и международными заказчиками\n"
    "{emoji1}разработала 100+ рекламных кампаний и десятки масштабных стратегий\n\n"
    "{emoji2}Забирай шаблон, без которого я не сажусь за аналитику ЦА. Или мини-аудит своей ЦА\n\n"
